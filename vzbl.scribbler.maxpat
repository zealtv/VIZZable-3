...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 10,
					"outlettype" : [ "", "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 149.666687, 106.0, 871.0, 22.0 ],
					"style" : "",
					"text" : "route x y pensize xoffset yoffset erase hue saturation lightness"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 350.666687, 599.0, 62.0, 22.0 ],
					"style" : "",
					"text" : "r ---topix2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 430.666687, 329.5, 64.0, 22.0 ],
					"style" : "",
					"text" : "s ---topix2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 541.0, 275.5, 93.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 430.666687, 275.5, 93.0, 22.0 ],
					"style" : "",
				...
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							...
							"parameter_longname" : "y displace",
							"parameter_shortname" : "y displace",
							"parameter_type" : 0,
							"parameter_mmax" : 1.0,
							"parameter_modmode" : 3,
...
, 			{
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_linknames" : 1,
							"parameter_longname" : "x displace",
							"parameter_shortname" : "x displace",
							"parameter_type" : 0,
							"parameter_mmax" : 1.0,
							"parameter_modmode" : 3,
							"parameter_initial_enable" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 642.0, 275.5, 88.0, 22.0 ],
					"style" : "",
					"text" : "prepend erase"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 293.5, 263.5, 35.0, 22.0 ],
					"style" : "",
					"text" : "* 0.2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 734.5, 497.5, 57.0, 22.0 ],
					"style" : "",
					"text" : "s ---topix"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1252.666748, 335.5, 57.0, 22.0 ],
					"style" : "",
					"text" : "s ---topix"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 149.666687, 362.5, 57.0, 22.0 ],
					"style" : "",
					"text" : "s ---topix"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 248.666687, 599.0, 55.0, 22.0 ],
					"style" : "",
					"text" : "r ---topix"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 293.5, 299.5, 99.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 216.666687, 299.5, 64.0, 22.0 ],
					"style" : "",
					"text" : "prepend y"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 293.5, 198.5, 44.0, 47.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 216.666687, 198.5, 44.0, 47.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 149.666687, 198.5, 44.0, 47.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1074.0, 615.0, 81.0, 22.0 ],
					"style" : "",
					"text" : "s ---loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 234.0, 24.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1163.0, 199.0, 79.0, 22.0 ],
					"style" : "",
					"text" : "r ---loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1020.0, 516.0, 193.0, 24.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1167.0, 615.0, 77.0, 22.0 ],
					"style" : "",
					"text" : "s getvzbldim"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 244.0, 849.0, 30.0, 22.0 ],
									"style" : "",
									"text" : "in 1"
								}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1074.0, 560.0, 79.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1020.0, 543.0, 305.0, 283.0 ],
					"presentation" : 1,
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-122" : [ "x", "x", 0 ],
			"obj-25" : [ "y displace", "y displace", 0 ],
			"obj-4" : [ "y", "y", 0 ],
			"obj-26" : [ "x displace", "x displace", 0 ]
		}
,
		"dependency_cache" : [ 			{
