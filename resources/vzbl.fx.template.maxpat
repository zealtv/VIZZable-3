...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 498.75, 809.0, 71.0, 22.0 ],
					"style" : "",
					"text" : "s vzblhover"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 498.75, 753.0, 71.0, 22.0 ],
					"style" : "",
					"text" : "prepend #0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 498.75, 706.0, 50.5, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 900.0, 434.5, 156.0, 60.0 ],
					"style" : "",
					"text" : "autopatter routes messages to all parameter objects with scripting names,"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 832.5, 400.5, 103.0, 22.0 ],
					"style" : "",
					"text" : "r  #0-messagesin"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 832.5, 472.5, 58.0, 22.0 ],
					"restore" : 					{
						"mix" : [ 0.5 ]
					}
,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1224.5, 94.5, 170.0, 33.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1215.5, 420.5, 132.0, 60.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1315.166748, 196.0, 98.0, 60.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1224.5, 33.5, 90.0, 22.0 ],
					"style" : "",
					"text" : "//UTILITY"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1224.5, 196.0, 88.0, 22.0 ],
					"style" : "",
					"text" : "r  #0-loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1224.5, 236.0, 77.0, 22.0 ],
					"style" : "",
					"text" : "s getvzbldim"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1437.166748, 196.0, 54.0, 20.0 ],
					"style" : "",
					"text" : "r vzbldim"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 1437.166748, 230.0, 46.0, 20.0 ],
					"style" : "",
					"text" : "unpack"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1396.166748, 286.0, 101.0, 21.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1343.5, 420.5, 64.0, 20.0 ],
					"style" : "",
					"text" : "r vzblmetro"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 444.0, 528.0, 77.0, 22.0 ],
					"style" : "",
					"text" : "prepend mix"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 845.5, 33.5, 66.0, 22.0 ],
					"style" : "",
					"text" : "//STYLE"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 444.0, 33.5, 147.0, 22.0 ],
					"style" : "",
					"text" : "//PARAMETERS"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 98.25, 477.0, 61.0, 22.0 ],
					"style" : "",
					"text" : "r #0-topix"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 444.0, 570.5, 66.0, 22.0 ],
					"style" : "",
					"text" : "s  #0-topix"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 845.5, 874.0, 297.0, 87.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 519.0, 408.5, 150.0, 33.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 45.0, 537.5, 104.0, 47.0 ],
					"style" : "",
					"text" : "set all GL objects to render to the vzbl context"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 500.0, 468.0, 193.0, 47.0 ],
					"style" : "",
					"text" : "set shortname of all interface objects to match respective scripting name"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 444.0, 108.5, 160.0, 33.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 933.5, 648.0, 113.0, 60.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 993.0, 256.0, 150.0, 100.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 444.0, 414.0, 73.0, 22.0 ],
					"style" : "",
					"text" : "outputvalue"
				}
...
, 			{
				"box" : 				{
					...
					"outputmode" : 0,
					"parameter_enable" : 0,
					"patching_rect" : [ 845.5, 575.5, 289.0, 25.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"annotation" : "Mix between the two input textures",
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 444.0, 461.0, 44.0, 47.0 ],
					"presentation" : 1,
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 83.0, 122.0, 124.0, 22.0 ],
									"style" : "",
									"text" : "mix"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 188.0, 82.0, 87.0, 22.0 ],
									"style" : "",
									"text" : "param mix 0.5"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 83.0, 180.0, 37.0, 22.0 ],
									"style" : "",
									"text" : "out 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 135.5, 82.0, 30.0, 22.0 ],
									"style" : "",
									"text" : "in 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 83.0, 82.0, 30.0, 22.0 ],
									"style" : "",
									"text" : "in 1"
								}
...
,
					"patching_rect" : [ 169.25, 537.5, 81.0, 23.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 444.0, 369.5, 79.0, 20.0 ],
					"style" : "",
					"text" : "r  #0-loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 845.5, 509.5, 289.0, 337.0 ],
					"presentation" : 1,
