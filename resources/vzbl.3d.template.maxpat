...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 343.0, 277.0, 61.0, 22.0 ],
					"style" : "",
					"text" : "turn 1 2 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 343.0, 244.0, 85.0, 22.0 ],
					"style" : "",
					"text" : "r #0-loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 343.0, 315.0, 78.0, 22.0 ],
					"style" : "",
					"text" : "jit.anim.drive"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 26.0, 268.0, 119.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 174.583252, 304.0, 150.0, 33.0 ],
					"style" : "",
					"text" : "draw all scene objects to node"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 222.083252, 568.5, 98.0, 47.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 150.083252, 502.5, 88.0, 22.0 ],
					"style" : "",
					"text" : "r  #0-loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 150.083252, 542.5, 77.0, 22.0 ],
					"style" : "",
					"text" : "s getvzbldim"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 152.5, 568.5, 54.0, 20.0 ],
					"style" : "",
					"text" : "r vzbldim"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 152.5, 602.5, 46.0, 20.0 ],
					"style" : "",
					"text" : "unpack"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 111.5, 658.5, 101.0, 21.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 79.583252, 354.0, 245.0, 52.0 ],
					"style" : "",
					"text" : "jit.gl.gridshape #0-node @depth_enable 1 @lighting_enable 1  @dim 10 10 @shape sphere @color 1.0 1.0 1.0 1.0 "
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 111.5, 706.5, 377.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 39.5, 49.0, 44.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 79.583252, 304.0, 75.0, 22.0 ],
					"style" : "",
					"text" : "r #0-tomesh"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 946.5, 749.0, 297.0, 87.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 127.5, 733.5, 145.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 601.0, 468.0, 193.0, 47.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 111.5, 782.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 98.25, 160.5, 30.0, 30.0 ],
					"style" : ""
				}
